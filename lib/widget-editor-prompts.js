...
import { BOOKING_WIDGET_KEY } from "./widget-themes.js";
...
function normalizeWidgetKey(value) {
  const trimmed = String(value ?? BOOKING_WIDGET_KEY).trim();
  return trimmed === BOOKING_WIDGET_KEY ? trimmed : BOOKING_WIDGET_KEY;
}
