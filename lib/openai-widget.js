  ...
  if (widgetKey === "booking_page_view") {
    ...
    if (preserveExistingCss) {
      instructions.push(
        ...
        "Treat the provided current page content as the preferred structure and copy baseline unless the request explicitly asks to change it.",
        "When the request asks for structural or content changes, update pageContent directly to reflect that new structure.",
        "It is valid to reorder sections, move the calendar, move supporting sections, change section types, add sections, remove sections, or simplify sections when the request asks for that.",
        "If the request asks to move or restructure content, do not keep the old layout out of inertia.",
